...
const Register = () => {
    return (
        <>
            <Container>
                <h1 className="shadow-sm  mt-5 p-3 text-center rounded regheading">Register</h1>
                <Row className="mt-5">
                    <Col lg={5} md={6} sm={12} className="p-5 m-auto  rounded-lg">
                    <img  className="Registerimage" src={RegImage} width="500px" height="400px"/>
                    </Col>
                    <Col lg={5} md={6} sm={12} className="p-5 m-auto shadow-sm rounded-lg Registerform">
                        <Form>
